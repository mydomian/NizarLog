        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="text-center d-flex justify-content-between">
                ...
                <a href="{{ route('agency-air-bill.index') }}" class="mt-3 btn btn-primary text-warning"><i class="mdi mdi-arrow-left-bold"></i> Booking Lists</a>
            </div>
            <div class="service-delivery-append mt-3">
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                    ...
                    <tr class="bg-warning">
                        <th>Staus</th>
                        <td class="text-uppercase">{{$airBill->status}}</td>
                    </tr>
                </table>
            </div>
          </div>
