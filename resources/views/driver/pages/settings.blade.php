...
<div class="modal fade" id="passwordModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{route('driver.password.confirm')}}" method="post">
        @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a href="{{route('driver.cancel.change.password')}}" class="btn-close"></a>
      </div>
      <form action="{{route('driver.password.update')}}" method="post">
        ...
        <div class="modal-footer">
          <a href="{{route('driver.cancel.change.password')}}" class="btn btn-secondary">Cancel</a>
          <button type="submit" class="btn btn-primary">Confirm</button>
        </div>
      </form>
    </div>
