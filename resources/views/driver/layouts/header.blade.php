          ...
          <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                  ...
                  <img src="@if(isset(Auth::user()->profile_photo_path)) {{ asset('/storage/profile/'.Auth::user()->profile_photo_path) }} @else {{ Auth::user()->profile_photo_url }} @endif" alt="profile"/>
                </a>
    ...
    <nav class="bottom-navbar">
      <div class="container">
          <ul class="nav page-navigation">
            <li class="nav-item">
              <a class="nav-link text-warning" href="{{route('driver.dashboard')}}">
