      ...
      <div class="col-md-12">
        <div class="card">
            <div class="text-center">
                <h5 class=" mt-3 text-warning">Transit Lists</h5>
            </div>
        <form action="{{ route('adminListsTransit') }}" method="post">
        @csrf
          <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="form-row">
                    <div class="col">
                        <select id="type" class="js-example-basic-single @error('type') is-invalid @enderror" name="type" style="width:100%" data-toggle="tooltip" data-placement="top" title="Select Type" required>
                  ...
                  <div class="col">
                    ...
                    <div class="col type-append d-none">
                        <select id="to_hub_id" class=" js-example-basic-single @error('to_hub_id') is-invalid @enderror" name="to_hub_id" style="width:100%" data-toggle="tooltip" data-placement="top" title="Select Hub">
           ...
           $('.js-example-basic-single').select2();
            ...
            $('#type').on('change', function() {
                if(this.value == 'transit'){
                    $('.type-append').removeClass('d-none');
                } else{
                    $('.type-append').addClass('d-none');
                }
            });
        })
    </script>
