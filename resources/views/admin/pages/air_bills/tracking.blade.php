        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="{{ route('adminTracking') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        ...
                                        @foreach ($airBooking->tracking as $tracking)
                                            ...
                                            @if ($tracking->status == 'assign_delivery_man')
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content">
                                                        ...
                                                        <p>From: {{ $tracking->booking->user->user_info->address ?? '' }} <br>
                                            ...
                                            @if ($tracking->status == 'delivery_hub')
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content">
                                                        <h2>Parcel Reached In {{ $tracking->toHub->hub_name ?? '' }} ({{ $tracking->toHub->hub_code ?? '' }})</h2>
                                                        <h6>Driver Name: {{ $tracking->driver->name ?? '' }}</h6>
                                                        <span class="cd-date" style="color:chocolate">{{ $tracking->created_at }} </span>
                                                    </div>
                                                </div>
